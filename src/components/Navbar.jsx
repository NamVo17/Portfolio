...
const Navbar = () => {
    ...
    const resumeUrl = "https://drive.google.com/file/d/1cqkIeAp-eICRRuWdEyG-Cy1e0ykkxQmB/view?usp=sharing";
                    ...
                    <div className="hidden md:block">
                        <div className="ml-8 flex items-center space-x-8">
                            ...
                            <a
                                ...
                                className="px-4 py-2 rounded-full bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white text-sm font-medium hover:opacity-90 transition-opacity"
                            >
                                Resume
                            </a>
                        </div>
            ...
            >
                <div className="px-4 py-6 space-y-4">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block px-4 py-3 mt-4 text-center rounded-full bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white text-lg font-medium hover:opacity-90 transition-opacity"
                        style={{
                            transform: isOpen ? "translateX(0)" : "translateX(50px)",
                            opacity: isOpen ? 1 : 0,
