...
const AboutPage = () => {
  ...
  return (
    <div
      className="h-auto pb-[10%] text-white overflow-x-clip px-[5%] sm:px-[5%] lg:px-[10%] mt-4 sm:mt-6 lg:mt-10" 
      id="About"
    >
      <Header />
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Detail-oriented Front-End Developer Fresher with hands-on experience in building responsive and dynamic interfaces using React.js, JavaScript, and modern UI libraries. Completed multiple projects, from ecommerce platforms to data-driven dashboards, focusing on scalability and performance optimization. I aim to refine my technical expertise and design thinking to become a Front-End Specialist who bridges creativity and engineering to craft seamless user experiences. </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1t5Dq11jEQeSidsT3te5ogW4MvDjBD-qP/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
