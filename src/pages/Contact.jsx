...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/vocongnam172@gmail.com';
      ...
      submitData.append('_subject', 'New message from portfolio site');
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
            Do you have any questions? Send me a message and I will reply you promptly.        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Got something to discuss? Message me and we can chat.
                </p>
              </div>
