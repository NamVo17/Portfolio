...
const WORDS = ["Aspiring IT Professional", "Digital Innovation Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/NamVo17" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/NamVo17/" },
  { icon: Instagram, link: "https://www.instagram.com/namvo1701/" },
  { icon: Mail, link: "https://mail.google.com/mail/?view=cm&to=vocongnam172@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Create innovative, user-friendly and functional websites for digital solutions                </p>
